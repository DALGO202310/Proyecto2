...
/**
 * Esta es una solucion alternativa al problema. Como grupo implementamos 2 propuestas de solucion pero decidimos conservar la
 * propuesta con el nombre: ProblemaP2.java por motivos de eficiencia en tiempo y espacio; sin embargo, entregamos las 2
 * soluciones como lo pide el enunciado.
 * 
...
public class SolucionAlternativaP2 {

    public static void main(String[] args) throws Exception{
        SolucionAlternativaP2 instancia= new SolucionAlternativaP2();
        try ( 
